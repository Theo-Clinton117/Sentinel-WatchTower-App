...
let ReportsController = class ReportsController {
    ...
    create(req, body) {
        return this.reportsService.create(req.user.sub, body);
    }
    flag(req, id, body) {
        return this.reportsService.flag(req.user.sub, id, body);
    }
    confirm(req, id) {
        return this.reportsService.confirm(req.user.sub, id);
    }
};
...
__decorate([
    ...
    __metadata("design:paramtypes", [Object, String]),
    __metadata("design:returntype", void 0)
], ReportsController.prototype, "confirm", null);
