...
const createStyles = (theme: ReturnType<typeof useAppTheme>, size: number) =>
  StyleSheet.create({
    shell: {
      ...
      overflow: 'hidden',
      borderWidth: 1,
      borderColor: theme.isDark ? 'rgba(169, 204, 255, 0.24)' : 'rgba(255, 255, 255, 0.88)',
      backgroundColor: theme.isDark ? 'rgba(21, 38, 74, 0.36)' : 'rgba(255, 255, 255, 0.72)',
    },
    shellActive: {
    ...
    highlight: {
      ...
      height: size * 0.34,
      borderRadius: 14,
      backgroundColor: theme.isDark ? 'rgba(255, 255, 255, 0.14)' : 'rgba(255, 255, 255, 0.62)',
    },
    innerGlow: {
      position: 'absolute',
      bottom: -size * 0.06,
